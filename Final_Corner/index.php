...
<body class="background-image">
    ...
    <section class="content">
        ...
        <form class="masonry" id="gallery" action="artwork.php" request="GET">
            ...
            ?>
                <button class="galleryImage" type="submit" name="artist" value="<?php echo $artist ?>"><img class="galleryImage" src="ArtworkPreviews/Artist=PP <?php echo $artist . ".jpg" ?>"></button>
            <?php
            }
            ?>
        </form>
